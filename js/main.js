...
(function ($) {
    ...
    var overlay_1, overlay_2, one_page_content, card_overlay, nav_overlay, tick;
    var first_load = true;
    ...
    $(function () {
        ...
        if ($("html").hasClass("one-page-layout")) {
            ...
            // add hash to links
            $(".nav-menu a, .nav-menu-icon a").each(function (index, element) {
                var menu_link = $(this);
  ...
  $(window).on('load', function () {
    ...
    // ------------------------------
    // HOME CARD LINKS
    var card = $('.card-overlay');
    $('.card-link').on('click', function(event) {
      $(card).addClass('show').css('transition-delay', '0s');
      $('.nav-menu a span').css('transition-delay', '.5s');
      // Play Sound Effect
      if (soundEffects) {
        tick.play();
    }
    ...
    $('.close-card').on('click', function(event) {
      $(card).removeClass('show').css('transition-delay', '.5s');
      $('.nav-menu a span').css('transition-delay', '0s');
    ...
    function setCurrentMenuItem() {
        ...
        if(activePageId !== "/") {
            $('.nav-menu-icon a[href="#' +  activePageId +'"]').parent().addClass('current-page').siblings().removeClass('current-page');
        } else {
            $('.nav-menu-icon a').parent().removeClass('current-page');
        }
    }
    }
    // ------------------------------
    ...
    function showPage(url) {
        ...
        nav_overlay.addClass("is-changing").css("transform", "translateY(-90%)");
        card_overlay.addClass("show");
        overlay_1.css("transition-delay", ".0s").css("transform", "translateY(10%)");
        overlay_2.css("transition-delay", ".2s").css("transform", "translateY(10%)");
    ...
    function showLoadedPage() {
        ...
        overlay_1
            ...
            .css("transform", "translateY(100%)");
        nav_overlay.css("transform", "translateY(-90%)");
    ...
    function closePage() {
        ...
        setTimeout(function () {
            ...
            overlay_1
                .css("transition-delay", ".2s")
                .css("transform", "translateY(-100%)");
            nav_overlay.removeClass("is-changing").css("transform", "translateY(0%)");
        }, 400);
    }
    // ------------------------------
